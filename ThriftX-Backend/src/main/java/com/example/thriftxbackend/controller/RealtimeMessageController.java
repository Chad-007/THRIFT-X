...
public class RealtimeMessageController {
    ...
    @GetMapping("/latest/{buyerId}")
    public List<Map<String, Object>> getLatestConversations(@PathVariable String buyerId) {
        return messageService.getLatestConversations(buyerId);
    }
}